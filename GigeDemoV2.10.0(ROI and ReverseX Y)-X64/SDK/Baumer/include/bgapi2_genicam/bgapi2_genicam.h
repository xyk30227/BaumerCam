/**
  ...
  and to retrieve the the accessible Interfaces.
...
extern "C" {
    ...
    */
    ...
    /**
      \ingroup    System
      \brief      Updates the list of of accessible interfaces and creates an object for each
      \param[in]  system   Pointer to the system (producer)
    ...
    */
    ...
    /**
      \ingroup    System
      \brief      Returns the number of accessible interfaces
      \param[in]  system           Pointer to the system (producer)
    ...
    */
    ...
    /**
      ...
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_NOT_INITIALIZED   Error for missing root node
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    ...
    */
    ...
    /**
      ...
      \param[in,out] string_length Result size, length of access status string (including string end zero)
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_ERROR             Internal error (init failed)
      \retval     BGAPI2_RESULT_NOT_INITIALIZED   Producer not initialized
      \retval     BGAPI2_RESULT_LOWLEVEL_ERROR    Can't read producer interface infos
    ...
    */
    ...
    /**
      ...
      The feature stacking will send many commands at once and therefore reduces the round trip times
    ...
    */
    ...
    /**
      \ingroup    Device
      \brief      End the stacking and write all features to the device
      \param[in]  device Pointer to the device
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_ERROR             Internal error (remote device not opened)
      \retval     BGAPI2_RESULT_NOT_INITIALIZED   Error for not opened device
    ...
    */
    ...
    /**
      \ingroup    Device
      \brief      End the stacking without writing features to the device
      \param[in]  device     Pointer to the device
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_ERROR             Internal error (remote device not opened)
      \retval     BGAPI2_RESULT_NOT_INITIALIZED   Error for not opened device
    ...
    */
    ...
    /**
      ...
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_NOT_INITIALIZED   The Device object is not open or the update plugin is not present.
    ...
    */
    ...
    /**
      ...
      \param[in]  device  Pointer to the device
      \param[in]  address The start address to write to.
      ...
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Device_WriteMemory(
        BGAPI2_Device* device,
        bo_uint64 address,
        bo_uint64 length,
        void* buffer);
    ...
    /**
      ...
      \param[in]  device  Pointer to the device
      \param[in]  address The start address to read from.
      \param[in]  length The length to read.
      \param[out] buffer The data from the device memory.
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_ERROR             Internal error (init failed)
      \retval     BGAPI2_RESULT_NOT_INITIALIZED   Error update mode is not set
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Device_ReadMemory(
        BGAPI2_Device* device,
        bo_uint64 address,
        bo_uint64 length,
        void* buffer);
    ...
    /**
      ...
      \param[in]  device  Pointer to the device
      \param[in]  uartname  enumvalue of boSerialSelector
      \param[in]  comportname  os specific name of pc comport
      \retval     BGAPI2_RESULT_SUCCESS             No error
      \retval     BGAPI2_RESULT_NOT_AVAILABLE       Missing cam genicam feature(s)
      \retval     BGAPI2_RESULT_NOT_IMPLEMENTED     Can't configure serial port
      \retval     BGAPI2_RESULT_OBJECT_INVALID      Internal object is invalid
      \retval     BGAPI2_RESULT_INVALID_PARAMETER   Error on open com port, no device
      \retval     BGAPI2_RESULT_LOWLEVEL_ERROR      Error on configure com port
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2_Device_SetSerialPort(
        BGAPI2_Device* device,
        char * uartname,
        char * comportname);
    ...
    */
    ...
    \brief      It is recommended to use the available event features instead of this function (see BGAPI2_DeviceEvent_GetNodeList).
    \param[in]  device_event Pointer to the device event
    \param[out] mem_ptr      Pointer to store the result
    \retval     BGAPI2_RESULT_SUCCESS           No error
    \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    \retval     BGAPI2_RESULT_NO_DATA The DeviceEvent object includes no event data. Possibly no device event has been received yet.
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_DeviceEvent_GetEventMemPtr(
        BGAPI2_DeviceEvent* device_event,
        void** mem_ptr);

    /**
    \ingroup    DeviceEvent
    \brief      This function delivers the size of the DeviceEvent object. Should be used in conjunction to BGAPI2_DeviceEvent_GetEventMemPtr.
    \param[in]  device_event Pointer to the device event
    \param[out] buffer_size  Pointer to store the result
    \retval     BGAPI2_RESULT_SUCCESS           No error
    \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_DeviceEvent_GetEventMemSize(
        BGAPI2_DeviceEvent* device_event,
    ...
    */
    ...
    /**
      ...
      \param[in]  pnp_event  Pointer to the pnp event
      \param[out] pnp_type   Pointer to store the result
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    ...
    */
    ...
    /**
      \ingroup    Buffer
      \brief      Returns a new buffer

      When using this constructor, the Buffer object takes care of memory management.
      The required memory for this Buffer object is allocated only when it is queued in the DataStream.
    ...
    */
    ...
    /**
      \ingroup    Buffer
      \brief      Returns a new buffer, initialized with user parameter and current payload size when added to the stream.
      ...
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_CreateBufferWithOptimizedSize(
    ...
    /**
      ...
      of the required memory. To use the actual required memory size the functions BGAPI2_Device_GetPayloadSize and
      BGAPI2_DataStream_GetPayloadSize are used respectively. To use the maximum required memory size of a device the
      maximum of the PayloadSize feature is queried. See BGAPI2_Device_GetRemoteNode and BGAPI2_Node_GetIntMax.
    ...
    */
    ...
    /**
      ...
      \param[out] mem_ptr   Pointer to store the result
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_NOT_AVAILABLE     The Buffer object is currently no memory allocated, because it was not queued to the DataStream. This error is returned only when using the internal memory allocation.
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
      \see        BGAPI2_CreateBuffer
      \see        BGAPI2_CreateBufferWithUserPtr
      \see        BGAPI2_CreateBufferWithOptimizedSize
    */
    ...
    */
    ...
    /**
      ...
      \brief      Use this function if the Buffer objects contains image data.
      \brief      This function works, if the Buffer object include Image or Jpeg data, with or without chunk.
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_NOT_AVAILABLE     The Buffer object doesn't include Image or Jpeg data.
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters

    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Buffer_GetImageLength(
        BGAPI2_Buffer* buffer,
        bo_uint64* image_length);
    ...
    */
    ...
    /**
      \ingroup    DataStream
      \brief      Returns the number of under run buffer of datastream
      \param[in]  data_stream   Pointer to the DataStream
    ...
    */
    ...
    /**
      ...
      If the image acquisition is done the filled Buffer object is moved into the output buffer queue and is fetched
    ...
    */
    ...
    /**
      \ingroup    Image
      \brief      Get the image data size from given image in byte
      \param[in]  image   Pointer to the image
      \param[out] length  Pointer to store the result
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    ...
    */
    ...
    /**
      ...
      \param[in]  img_src           Pointer to the source image
      \param[in]  img_src           Pointer to the destination image
      \param[in]  scaling_factor_x  The scaling factor parameter for x direction. range 0.5 to 2.0
      \param[in]  scaling_factor_y  The scaling factor parameter for y direction. range 0.5 to 2.0
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_ERROR             Error for invalid image or unsupported pixel format
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Image_Scale(
        BGAPI2_Image* img_src,
        BGAPI2_Image* img_dst,
    ...
    */
    ...
    /**
      \ingroup    ImgProc
      \brief      Transforms an given image using the pixelformat using the image processor
      \param[in]  img_proc     Pointer to the image processor
    ...
    */
    typedef enum {
        ...
        BGAPI2_POLARIZER_AOP_R            = 0x100 | BGAPI2_POLARIZER_AOP,
        ///< Enum value DOLP_R - Degree of linear polarization (red)
        BGAPI2_POLARIZER_DOLP_R           = 0x100 | BGAPI2_POLARIZER_DOLP,
        ///< Enum value ADOLP_R - Angle and degree of linear polarization (red)
        BGAPI2_POLARIZER_ADOLP_R          = 0x100 | BGAPI2_POLARIZER_ADOLP,
        ///< Enum value Intensity_R - Gray scale image (red)
        BGAPI2_POLARIZER_INTENSITY_R      = 0x100 | BGAPI2_POLARIZER_INTENSITY,
        ///< Enum value Pol0Deg_R - The polarization information 0 degrees (red)
        BGAPI2_POLARIZER_POL0_DEG_R       = 0x100 | BGAPI2_POLARIZER_POL0_DEG,
        ///< Enum value Pol45Deg_R - The polarization information 45 degrees (red)
        BGAPI2_POLARIZER_POL45_DEG_R      = 0x100 | BGAPI2_POLARIZER_POL45_DEG,
        ///< Enum value Pol90Deg_R - The polarization information 90 degrees (red)
        BGAPI2_POLARIZER_POL90_DEG_R      = 0x100 | BGAPI2_POLARIZER_POL90_DEG,
        ///< Enum value Pol135Deg_R - The polarization information 135 degrees (red)
        BGAPI2_POLARIZER_POL135_DEG_R     = 0x100 | BGAPI2_POLARIZER_POL135_DEG,
        ///< Enum value ReflectionMin_R - Image with suppressed reflections (red)
        BGAPI2_POLARIZER_REFLECTION_MIN_R = 0x100 | BGAPI2_POLARIZER_REFLECTION_MIN,
        ///< Enum value ReflectionMax_R - Image with enhanced reflections (red)
        BGAPI2_POLARIZER_REFLECTION_MAX_R = 0x100 | BGAPI2_POLARIZER_REFLECTION_MAX,
        ///< Enum value POL_R - Polarized (red)
        BGAPI2_POLARIZER_POL_R            = 0x100 | BGAPI2_POLARIZER_POL,
        ///< Enum value UNPOL_R - Unpolarized (red)
        BGAPI2_POLARIZER_UNPOL_R          = 0x100 | BGAPI2_POLARIZER_UNPOL,

        ///< Enum value AOP_G - Angle of polarization (green)
        BGAPI2_POLARIZER_AOP_G            = 0x200 | BGAPI2_POLARIZER_AOP,
        ///< Enum value DOLP_G - Degree of linear polarization (green)
        BGAPI2_POLARIZER_DOLP_G           = 0x200 | BGAPI2_POLARIZER_DOLP,
        ///< Enum value ADOLP_G - Angle and degree of linear polarization (green)
        BGAPI2_POLARIZER_ADOLP_G          = 0x200 | BGAPI2_POLARIZER_ADOLP,
        ///< Enum value Intensity_G - Gray scale image (green)
        BGAPI2_POLARIZER_INTENSITY_G      = 0x200 | BGAPI2_POLARIZER_INTENSITY,
        ///< Enum value Pol0Deg_G - The polarization information 0 degrees (green)
        BGAPI2_POLARIZER_POL0_DEG_G       = 0x200 | BGAPI2_POLARIZER_POL0_DEG,
        ///< Enum value Pol45Deg_G - The polarization information 45 degrees (green)
        BGAPI2_POLARIZER_POL45_DEG_G      = 0x200 | BGAPI2_POLARIZER_POL45_DEG,
        ///< Enum value Pol90Deg_G - The polarization information 90 degrees (green)
        BGAPI2_POLARIZER_POL90_DEG_G      = 0x200 | BGAPI2_POLARIZER_POL90_DEG,
        ///< Enum value Pol135Deg_G - The polarization information 135 degrees (green)
        BGAPI2_POLARIZER_POL135_DEG_G     = 0x200 | BGAPI2_POLARIZER_POL135_DEG,
        ///< Enum value ReflectionMin_G - Image with suppressed reflections (green)
        BGAPI2_POLARIZER_REFLECTION_MIN_G = 0x200 | BGAPI2_POLARIZER_REFLECTION_MIN,
        ///< Enum value ReflectionMax_G - Image with enhanced reflections (green)
        BGAPI2_POLARIZER_REFLECTION_MAX_G = 0x200 | BGAPI2_POLARIZER_REFLECTION_MAX,
        ///< Enum value POL_G - Polarized (green)
        BGAPI2_POLARIZER_POL_G            = 0x200 | BGAPI2_POLARIZER_POL,
        ///< Enum value UNPOL_G - Unpolarized (green)
        BGAPI2_POLARIZER_UNPOL_G          = 0x200 | BGAPI2_POLARIZER_UNPOL,

        ///< Enum value AOP_B - Angle of polarization (blue)
        BGAPI2_POLARIZER_AOP_B            = 0x300 | BGAPI2_POLARIZER_AOP,
        ///< Enum value DOLP_B - Degree of linear polarization (blue)
        BGAPI2_POLARIZER_DOLP_B           = 0x300 | BGAPI2_POLARIZER_DOLP,
        ///< Enum value ADOLP_B - Angle and degree of linear polarization (blue)
        BGAPI2_POLARIZER_ADOLP_B          = 0x300 | BGAPI2_POLARIZER_ADOLP,
        ///< Enum value Intensity_B - Gray scale image (blue)
        BGAPI2_POLARIZER_INTENSITY_B      = 0x300 | BGAPI2_POLARIZER_INTENSITY,
        ///< Enum value Pol0Deg_B - The polarization information 0 degrees (blue)
        BGAPI2_POLARIZER_POL0_DEG_B       = 0x300 | BGAPI2_POLARIZER_POL0_DEG,
        ///< Enum value Pol45Deg_B - The polarization information 45 degrees (blue)
        BGAPI2_POLARIZER_POL45_DEG_B      = 0x300 | BGAPI2_POLARIZER_POL45_DEG,
        ///< Enum value Pol90Deg_B - The polarization information 90 degrees (blue)
        BGAPI2_POLARIZER_POL90_DEG_B      = 0x300 | BGAPI2_POLARIZER_POL90_DEG,
        ///< Enum value Pol135Deg_B - The polarization information 135 degrees (blue)
        BGAPI2_POLARIZER_POL135_DEG_B     = 0x300 | BGAPI2_POLARIZER_POL135_DEG,
        ///< Enum value ReflectionMin_B - Image with suppressed reflections (blue)
        BGAPI2_POLARIZER_REFLECTION_MIN_B = 0x300 | BGAPI2_POLARIZER_REFLECTION_MIN,
        ///< Enum value ReflectionMax_B - Image with enhanced reflections (blue)
        BGAPI2_POLARIZER_REFLECTION_MAX_B = 0x300 | BGAPI2_POLARIZER_REFLECTION_MAX,
        ///< Enum value POL_B - Polarized (blue)
        BGAPI2_POLARIZER_POL_B            = 0x300 | BGAPI2_POLARIZER_POL,
        ///< Enum value UNPOL_B - Unpolarized (blue)
        BGAPI2_POLARIZER_UNPOL_B          = 0x300 | BGAPI2_POLARIZER_UNPOL,
    ...
    */
    ...
    /**
      ...
      \param[in]  device The BGAPI2_Device* pointer to an opened polarization camera (it must be able to read
    *             features from the camera)
      \param[out] is_polarized If true, the Device is a polarization camera.
      \param[out] is_color If true, the Device is a color polarization camera otherwise a mono polarization camera.
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
      \retval     BGAPI2_RESULT_ERROR             Internal error
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Polarizer_IsPolarized(
        BGAPI2_Device* device,
        bo_bool* is_polarized,
        bo_bool* is_color);
    ...
    */
    ...
    /**
      ...
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Polarizer_EnableSingleFormat(
        BGAPI2_Polarizer* polarizer,
    ...
    */
    ...
    /**
      ...
      \brief      Get the calculated component (BGAPI_POLARIZER_AOP, etc.) from the buffer.
                  If the Image object doesn't fit the resulting data, the Polarizer will reinitialize it
                  accordingly.

      For performance reasons when handling more than one component, a component must first be enabled via the
      BGAPI2_Polarizer_Enable() methods
    ...
    */
    ...
    /**
      \ingroup       Polarizer
      \brief         Get the calculated component (BGAPI_POLARIZER_AOP, etc.) from the buffer.
                     The passed Image object is fully predefined (width, height, pixel format, buffer and buffer size)
                     and the polarization data are transformed to desired pixel format.

      For performance reasons when handling more than one component, a component must first be enabled
      via the BGAPI2_Polarizer_Enable() methods.

      \param[in]     polarizer  Instance of polarizer
      \param[in]     format The format to retrieve.
      \param[in/out] image A Image to store the result of the calculation. The passed Image object is fully predefined
      ...
      \retval     BGAPI2_RESULT_ERROR             Internal error
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Polarizer_GetByPredefinedImage(
        BGAPI2_Polarizer* polarizer,
        BGAPI2_POLARIZER_FORMATS format,
        BGAPI2_Image* image);
    ...
    */
    ...
    /**
      ...
      \param[in]  format        The polarization format
      \param[in]  color         Perform check for mono or color camera.
      \param[out] is_available  The availabity result
      \see        BGAPI2_POLARIZER_FORMATS
      \retval     BGAPI2_RESULT_SUCCESS           No error
      \retval     BGAPI2_RESULT_INVALID_PARAMETER Error for invalid parameters
    */
    BGAPI2_C_DECL BGAPI2_RESULT BGAPI2CALL BGAPI2_Polarizer_IsFormatAvailable(
        BGAPI2_POLARIZER_FORMATS format,
        bo_bool color,
        bo_bool* is_available);
    ...
    */
    ...
    /**
      \ingroup    Trace
      \brief      Activate the tracing to an output file
